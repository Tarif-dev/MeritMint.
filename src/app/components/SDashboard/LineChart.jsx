...
export default function BasicArea() {
  // Use useRef to persist the chart instance
  ...
  return (
    <>
      <div class="w-full h-auto bg-gray-500/50 border-2 border-blue-500 rounded-lg shadow dark:bg-gray-800 p-4 md:p-6 z-10">
